...
<html lang="en">
  <head>
    ...
    <title> Sistem Informasi Penjualan PT Sharkzilla </title>
      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <center>
            &nbsp; <a href="index.php" class="fa fa-mortar-board fa-2x" style="color:#fff;"><span><font size="4.95" color="white" face="Helvetica Neue">Sistem Informasi Penjualan</font></span></a>
            </center>
            </div>
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" >
                  <a href="#" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                    <img src="assets/images/image.jpg" alt="">Ahmad Muji
                  </a>
      ...
      switch ($queries['page']) {
        ...
        <footer>
          <div class="pull-right">
            Copyright @ 2020 Aplikasi sistem informasi : Ahmad Muji
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
